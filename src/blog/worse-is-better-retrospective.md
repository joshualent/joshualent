...
author: 'Joshua Lent'
description: "The Worse is Better trilogy is interesting"
pubDate: 2025-10-23
...
As someone who has worked on but not shipped a much software, I have to admit worse is better for some cases. A half finished project is worse than a half-baked but completed one. So if you only have the time (or knowledge/skills) for worse, worse is better.
